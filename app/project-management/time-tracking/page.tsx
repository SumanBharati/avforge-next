...
export default function TimeTrackingPage() {
  ...
  // Unique project/phase combos with either an allocation or a time entry this week
  const rows = useMemo(() => {
  ...
  function confirmAddRow() {
    ...
    // Skip if this project/phase row already exists this week
