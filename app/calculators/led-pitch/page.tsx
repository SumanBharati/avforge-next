...
export default function LEDPitchPage() {
  ...
  return (
    <CalcPageWrapper title="LED Pixel Pitch" desc="Optimal pitch and resolution for LED walls">
      {/* Inputs and References share the first grid row so they stay the same
          height; Results sits below Inputs. DOM order keeps the mobile stack
          as Inputs, Results, References. */}
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_800px]">

        <div className="min-w-0 rounded-xl border border-border bg-forge-surface/50 p-5 lg:col-start-1 lg:row-start-1">
        ...
        <div className="min-w-0 rounded-xl border border-border bg-forge-surface/50 p-5 lg:col-start-1 lg:row-start-2">
        ...
        <div className="rounded-xl border border-violet-500/20 bg-violet-500/[0.06] p-5 lg:col-start-2 lg:row-start-1">
